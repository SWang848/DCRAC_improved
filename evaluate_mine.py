...
logs_file_path = os.path.join(os.getcwd(), 'output/logs/rewards_P_2-regular')
...
# last_episode_chart_compare(logs_file_path, os.path.join(os.getcwd(), 'output/logs/rewards_P_6-regular'))
